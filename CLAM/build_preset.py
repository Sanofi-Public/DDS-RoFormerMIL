...
parser.add_argument("--preset_name", type=str, help="name of preset")
parser.add_argument(
    "--seg_level", type=int, default=-1, help="downsample level at which to segment"
)
parser.add_argument("--sthresh", type=int, default=8, help="segmentation threshold")
parser.add_argument("--mthresh", type=int, default=7, help="median filter threshold")
parser.add_argument("--use_otsu", action="store_true", default=False)
parser.add_argument(
    "--close", type=int, default=4, help="additional morphological closing"
)
parser.add_argument("--a_t", type=int, default=100, help="area filter for tissue")
parser.add_argument("--a_h", type=int, default=16, help="area filter for holes")
parser.add_argument(
    "--max_n_holes",
    type=int,
    default=8,
...
parser.add_argument(
    "--vis_level", type=int, default=-1, help="downsample level at which to visualize"
)
parser.add_argument(
    "--line_thickness",
    type=int,
